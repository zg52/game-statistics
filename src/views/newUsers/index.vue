<template>
  <div>
		<application-header @getTime="handleGetTime" @getChannel="handleGetChannel" @getVersion="handleGetVersion"/>
        ...
        <a-tabs default-active-key="1" @change="callback">
          <a-tab-pane key="1" tab="新增用户">
            <div class="chart-wrapper">
              <line-chart name="新增用户数" :height="hourHeight" :chartData="chartData"/>
              ...
              <div class="newUsers-tables">
                <a-table v-if="isPutAway" :columns="columns" :data-source="data" @change="onChangePagination"></a-table>
              </div> -->
            </div>
          </a-tab-pane>
        </a-tabs>
